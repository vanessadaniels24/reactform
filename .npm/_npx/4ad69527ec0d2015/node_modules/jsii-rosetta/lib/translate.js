...
class SnippetTranslator {
    constructor(snippet, options = {}) {
        ...
        const fakeCurrentDirectory = snippet.parameters?.[snippet_1.SnippetParameters.$COMPILATION_DIRECTORY] ??
            snippet.parameters?.[snippet_1.SnippetParameters.$PROJECT_DIRECTORY];
...
function rosettaDiagFromTypescript(diag) {
    return {
        ...
        isFromStrictAssembly: (0, util_2.hasStrictBranding)(diag),
